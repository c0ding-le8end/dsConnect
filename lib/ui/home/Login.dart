    ...
    return Scaffold(
        body: SingleChildScrollView(
          child: Container(height:MediaQuery.of(context).size.height,width:MediaQuery.of(context).size.width,decoration: BoxDecoration(
            ...
            child: Obx(()
            {
              if(controller.phoneNumberEntered.value==0)
                {
                return Column(
                children: <Widget>[
                Container(
            ...
            child: Icon(
              ...
              child: TextFormField(controller: controller.phoneController,cursorColor: Colors.black87,
            ...
            child: Center(
            child: Obx(()=>controller.codeSent.value==false?Text("Send otp", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),
            ...
            {
            controller.phoneNumberEntered.value=2;
